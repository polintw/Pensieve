...
exports._promise_composeUsersBasic = (connection, dataObj)=>{
...
exports._promise_composeMarksBasic = (connection, dataObj, basis)=>{
  return new Promise((resolve, reject)=>{
...
exports._promise_composeUnitsBasic = (connection, dataObj, basis)=>{
    return new Promise((resolve, reject)=>{
