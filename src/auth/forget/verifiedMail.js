...
const _render_HtmlBody = (token, userInfo)=>{
  return (
    ...
    domain.name+
    '/" target="_blank" class="boxLogo plainLinkButton"> <!-- <SvgLogo/> --> <img src="http://' +
    domain.name+
