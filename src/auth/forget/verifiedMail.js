...
const _render_HtmlBody = (token, userInfo)=>{
  return (
    ...
    userInfo.first_name +
    '. </h2> <p> We have received a request to<strong> reset the password</strong> for your Cornerth.com account. <!--You received this mail is because,<br/> there is a request for<strong> restting your account password</strong> on Cornerth.com--> </p> <p> Please <a href="https://'+
    domain.name+ '/s/resend/pwreset?token='+ token +
    '">click here</a><br/> <span> to verify your identity and reset your password.</span> </p> <p> If this was not you, please contact us and remain using your current password.<br/> Do not worry! Your account is still under protection. <!--If this is not you, please contact us and keep using the current password you have.<br/> The account is still under the protection safely.--> </p> <p class="colorEditLightBlack"> For your account safety, we highly recommend that your password must contain at least 8 characters in length including both letters and digits. </p> <p style="padding: 30px 0;"> Enjoy your adventure on Cornerth, leave the problem to us. </p> </div> <div class="mailBoxContentTail"> <div> <span class="colorEditLightBlack fontContent"> Best Wishes,</span> </div> <div> <span class="colorEditLightBlack fontContent"> Cornerth. Team</span> </div> </div> </div> <div class="boxFooter"> <a href="https://cornerth.com/" target="_blank" class="boxLogoReverse plainLinkButton" style="margin-top: 20px; text-align: center;"> <!-- <SvgLogo/> --> <img src="http://'+
    domain.name+
    '/png/Logo_reverse.png" style= "height:auto; width: 100%; position:relative; box-sizing: border-box; "> </a> <div class="boxFooter"> <!--class="boxServiceLink"--> <!-- <ServiceLinks/> --> <div class="boxServiceLink"> <a href="https://www.facebook.com/pg/cornerth.center/about/" target="_blank" method="about" style="color:white" class="plainLinkButton tagServiceLink fontServiceLink colorLightStandard"> About</a> <span class="tagServiceLink fontServiceLink colorGrey">．</span> <a href="https://cornerth.com/a/privacy" method="privacy" style="color:white" class="plainLinkButton tagServiceLink fontServiceLink colorLightStandard"> Privacy</a> <span class="tagServiceLink fontServiceLink colorGrey">．</span> <a href="https://cornerth.com/a/terms" method="terms" style="color:white" class="plainLinkButton tagServiceLink fontServiceLink colorLightStandard"> Terms</a> <span class="tagServiceLink fontServiceLink colorGrey">．</span> <a href="https://www.facebook.com/cornerth.center/" target="_blank" method="contact" style="color:white" class="plainLinkButton tagServiceLink fontServiceLink colorLightStandard"> Contact</a> </div> <div class="boxServiceLink fontTitleSmall colorGrey"> <span>Cornerth., Inc.</span> <span>All Rights Reserved.</span> </div> </div> </div> </div></body></html>'
  );
};
