...
const _render_HtmlBody = (token, userInfo)=>{
  return (
    ...
    '">click here</a> <span> today<br/> verifying your email address to complete your registration.</span> </p> <p style="padding: 30px 0;"> Enjoy your adventure, and nice to meet you! </p> </div> <div class="mailBoxContentTail"> <div> <span class="colorEditLightBlack fontContent"> Best Wishes,</span> </div> <div> <span class="colorEditLightBlack fontContent"> Cornerth. Team</span> </div> </div> </div> <div class="boxFooter"> <a href="https://cornerth.com/" target="_blank" class="boxLogoReverse plainLinkButton" style="margin-top: 20px; text-align: center;"> <!-- <SvgLogo/> --> <img src="https://'+
    domain.name+
