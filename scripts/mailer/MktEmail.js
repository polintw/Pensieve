...
const _render_HtmlBody = (mailUnitArr)=>{
  ...
  return(
    '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml"> <head> <meta http-equiv="Content-Type" content="text/html; charset=utf-8"> <meta name="viewport" content="width=device-width, initial-scale=1.0001, minimum-scale=1.0001, maximum-scale=1.0001, user-scalable=no"> <!--[if !mso]><!--> <meta http-equiv="X-UA-Compatible" content="IE=Edge"> <!--<![endif]--> <style type="text/css">html { font-family: "Lato", "Noto Sans TC", "微軟正黑體", "Helvetica Neue", Helvetica, Futura, sans-serif, Arial; } body { margin: 0; width: 100%; } .mailMain { width: 100%; box-sizing: border-box; padding: 12.5px 5%; } .mailBoxContent { width: 100%; box-sizing: border-box; padding: 15px 5.5%; text-align: center; overflow: hidden; } .mailBoxContentGreet { padding: 2px 0 16px; margin: 0; } .mailBanner{ width: 400px; box-sizing: border-box; margin:0 auto; } .imgThumb { display: inline-block; width: 80%; height: 280px; box-sizing: border-box; background-size: cover; background-position: 50% 50%; background-repeat: no-repeat; overflow: hidden; } .setBox{ display: inline-block; width:45%; min-width: 320px; max-width: 90vw; padding:0 10px; margin:36px 0 20px; text-align: center; } .boxTitleThumb { padding: 15px 10% 8px; text-align: left; white-space: nowrap; } .boxThumbNodes { padding: 8px 10% 15px; text-align: left; } .plainLinkButton { text-decoration: none; color: inherit; } .boxFooter { width: 100%; box-sizing: border-box; text-align: center; background-color: rgb(117,117,117); margin-bottom: 16px; clear: both; } .boxServiceLink { padding: 10px; white-space: nowrap; } .boxLogo { display: inline-block; width: 100px; min-width: 12vw; box-sizing: border-box; cursor: pointer; float: left; } .boxLogoReverse { display: inline-block; width: 160px; max-width: 63vw; min-width: 136.6px; box-sizing: border-box; margin: 40px 40% 10px; cursor: pointer; } .spanTitleDate { display: inline-block; float: right; } .tagServiceLink { display: inline-block; box-sizing: border-box; margin-bottom: 1px; } .fontContent { font-size: 14px; line-height: 1.5; } .fontContentPlain { font-size: 14px; } .fontTitle { font-size: 24px; } .fontSubtitle { font-size: 16px; } .fontNodesEqual_L5 { font-size: 20px; line-height: 1.5; } .fontSubmit { font-size: 24px; } .fontTitleSmall { font-size: 12px; line-height: 1.5; } .fontServiceLink { font-size: 12px; font-weight: bold; } .weightBold { font-weight: bold; } .colorWhite { color: #ffffff } .colorStandard { color: #ff8168; } .colorDescripBlack { color: #444444; } .colorEditBlack { color: #545454; } .colorEditLightBlack { color: #757575; } .colorLightStandard { color: #fff8f7; } .colorLightGrey { color: #b8b8b8; } .colorGrey { color: #a3a3a3; } .signInButton { display: inline-block; padding: 15px 32px; margin: 10px; border-radius:4px; background-color: #ff8168; text-align: center; cursor: pointer; } </style> </head><body><div class="mailMain"> <div style="border:solid 1px #d8d8d8; width: 90%; margin: 31.25px 5% 12.5px;"></div> <div class="mailBoxContent"> <a href="https://www.cornerth.com/" target="_blank" class="boxLogo plainLinkButton"> <!-- <SvgLogo/> --> <img src="http://www.cornerth.com/png/Logo.png" style= "height:auto; width: 100%; position:relative; box-sizing: border-box; "> </a> <span class="spanTitleDate fontContentPlain colorLightGrey weightBold">' +
    month +date + ', '+year +
