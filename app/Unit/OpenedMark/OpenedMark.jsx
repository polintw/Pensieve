...
class OpenedMark extends React.Component {
  ...
  render(){
    ...
    */
    ...
    if(!this.props.editingModal){ // read mode, deal with 'overflow' number
    ...
    if( cssVW < 860 ){ // on small screen, no position assign
      [blockLeft, blockRight, blockTop, blockTopTranslate] = ['','', this.props.editingModal ? 0 : "unset", 0];
    };
        ...
        <Draggable
          ...
          <span
            ...
            style={Object.assign({},{
              left: blockLeft,
              right: blockRight,
              top: (typeof blockTop === "number") ? (blockTop + '%') : blockTop,
            })}
