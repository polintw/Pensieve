...
class FeedEmpty extends React.Component {
  ...
  render(){
    return (this.props.userId == this.props.userInfo.id) ?(
      <div className={styles.comFeedEmpty}>
        <div
          ...
          {this.props.i18nUIString.catalog['guiding_noAccumulated_pathShareInvitation']}
          <br/>
        </div>
        <div
      ...
      <div className={styles.comFeedEmpty}>
        <div
          className={classnames(styles.boxTitle, styles.boxEmptyDescript, "fontTitleSmall", "colorLightGrey")}>
          {this.props.i18nUIString.catalog['guiding_noAccumulated_waitAuthor']}
          <br/>
        </div>
      </div>
    )
