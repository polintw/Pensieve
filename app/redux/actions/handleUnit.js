...
export function setUnitAxiosGeneral() {
  ...
  return (dispatch, getState) => {
    ...
    const currentUnitAxiosGeneral =  getState().unitAxiosGeneral;
    dispatch({type: UNIT_AXIOSGENERAL_SWITCH, unitAxiosGeneral: currentUnitAxiosGeneral? false: true});
