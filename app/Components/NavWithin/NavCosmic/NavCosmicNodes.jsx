...
class NavCosmicNodes extends React.Component {
  constructor(props){
    super(props);
    this.state = {
  ...
  render(){
    return(
        <div
            className={classnames(styles.comNavCosmicNodes)}>
          <Link
              to={"/cosmic/nodes"}
              topath={"nodes"}
              className={
              ...
              <span
                  className={classnames(
                      ...
                      {
                          [styles.spanLinkMouse]: (this.state.onNavLink == 'nodes' ),
                      }
                  )}>
                    {this.props.i18nUIString.catalog["title_Nodes"]}
              </span>
          </Link>
        </div>
    )
