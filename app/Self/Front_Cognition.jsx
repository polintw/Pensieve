...
export default class FrontCognition extends React.Component {
  constructor(props){
    ...
    this.style={
      ...
      Front_Cognition_bottom_NavCollateral_: {
        position: 'absolute',
        top: '0',
        right: '32%',
        fontSize: '1.1rem',
      ...
      Front_Cognition_bottom_NavFront_: {
        position: 'absolute',
        bottom: '18%',
        right: '18%',
        fontSize: '1.1rem',
      ...
      Front_Cognition_bottom_UserName_: {
        width: '34%',
        height: '100%',
        position: 'absolute',
        top: '0',
      ...
      Front_Cognition_bottom_UserName_svg_: {
      ...
      Front_Cognition_bottom_UserName_span_: {
        display: 'inline-block',
        position: 'absolute',
        bottom: '18%',
        left: '0',
  ...
  render(){
    ...
    return(
      <div
        ...
        <div
          style={this.style.Front_Cognition_bottom_}>
          <div
            style={this.style.Front_Cognition_bottom_NavCollateral_}>
            <NavCollateral
              _set_Focus={this._set_Focus}/>
          </div>
          <div
            style={this.style.Front_Cognition_bottom_NavFront_}>
            <NavFront/>
          </div>
          <div
            style={this.style.Front_Cognition_bottom_UserName_}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 182 182"
              style={this.style.Front_Cognition_bottom_UserName_svg_}>
            ...
            <span style={this.style.Front_Cognition_bottom_UserName_span_}>{this.props.userBasic.account}</span>
          </div>
        </div>
      </div>
    )
