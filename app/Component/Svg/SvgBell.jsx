  ...
  render(){
    ...
    return(
      <svg xmlns="http://www.w3.org/2000/svg"
        ...
        <defs>
          <style>{".cls-1-bell,.cls-2-bell,.cls-3-bell,.cls-4-bell{fill:none;stroke:#a0a0a0;}.cls-1-bell,.cls-2-bell{stroke-linejoin:round;}.cls-1-bell{stroke-width:4px;}.cls-2-bell,.cls-3-bell{stroke-linecap:round;}.cls-2-bell{stroke-width:7px;}.cls-3-bell,.cls-4-bell{stroke-miterlimit:10;stroke-width:6px;}.cls-5-bell{fill:"+
            (this.props.colorSwitch? "#636363": "#a0a0a0")+";}"}</style>
        </defs>
