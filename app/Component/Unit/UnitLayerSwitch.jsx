    ...
    return(
      <div
        ...
        <svg
          ...
          <defs>
            <style>{".cls-1{fill:#f7f4bc;stroke:#f7f4bc;stroke-miterlimit:10;}"}</style>
          </defs>
          <g id="圖層_2" data-name="圖層 2">
            <g id="圖層_2-2" data-name="圖層 2">
              <path className="cls-1" d="M.5.5v45c0,5.5,5.4,10,12,10h10c6.6,0,12-4.5,12-10V.5Z"/>
            </g></g>
        </svg>
        <svg
          ...
          <defs>
            <style>
              {".cls-1{fill:none;stroke:#f7f4bc;stroke-miterlimit:10;}"}
            </style>
          </defs>
          <g id="圖層_2" data-name="圖層 2">
            <g id="圖層_2-2" data-name="圖層 2">
              <path className="cls-1" d="M.5,55.5v-45C.5,5,5.9.5,12.5.5h10c6.6,0,12,4.5,12,10v45Z"/></g></g>
        </svg>
      </div>
    )
  }
